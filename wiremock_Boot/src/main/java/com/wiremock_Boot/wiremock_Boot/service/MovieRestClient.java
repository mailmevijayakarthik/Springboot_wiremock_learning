package com.wiremock_Boot.wiremock_Boot.service;

import com.wiremock_Boot.wiremock_Boot.constant.MovieAppConstants;
...
public class MovieRestClient {
    ...
    /*
    In Spring Boot removing the below constructor and adding an Autowire for webclient .
    Actual configuration for the webclient is in config package under MovieAppConfig
